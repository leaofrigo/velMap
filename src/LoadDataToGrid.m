function [Vr1,Vr2,Vr3,Lat1,Lon1,utmx, utmy,zone,TFTot] = LoadDataToGrid(LongTot,LatTot,zone,...
...
Vr1 = griddata(LongTot,LatTot,AverageVelocityVectorTot1,Lon1,Lat1);
Vr2 = griddata(LongTot,LatTot,AverageVelocityVectorTot2,Lon1,Lat1);
Vr3 = griddata(LongTot,LatTot,AverageVelocityVectorTot3,Lon1,Lat1);
