function [] = simulationRiver3D(Quiver3VectorXTot,Quiver3VectorYTot,...
    Quiver3VectorZTot,Quiver3VectorUTot,Quiver3VectorVTot,Quiver3VectorWTot,...
    YrR,XrR,FrR,alt,bat,direcao,handles)
...
switch direcao
    case 'North'
        VEL3D = griddata(Quiver3VectorXTot,Quiver3VectorYTot,Quiver3VectorZTot,Quiver3VectorVTot,X1,Y1,Z1);
    case 'East'
        VEL3D = griddata(Quiver3VectorXTot,Quiver3VectorYTot,Quiver3VectorZTot,Quiver3VectorUTot,X1,Y1,Z1);
    case 'Upstream'
        VEL3D = griddata(Quiver3VectorXTot,Quiver3VectorYTot,Quiver3VectorZTot,Quiver3VectorWTot,X1,Y1,Z1);
    case'Magnitude'
