function varargout = VelMAP(varargin)
% VELMAP MATLAB code for VelMAP.fig
%      VELMAP, by itself, creates a new VELMAP or raises the existing
%      singleton*.
%
%      H = VELMAP returns the handle to a new VELMAP or the handle to
%      the existing singleton*.
%
%      VELMAP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VELMAP.M with the given input arguments.
%
%      VELMAP('Property','Value',...) creates a new VELMAP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before VelMAP_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to VelMAP_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help VelMAP

% Last Modified by GUIDE v2.5 27-Jun-2016 00:35:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @VelMAP_OpeningFcn, ...
                   'gui_OutputFcn',  @VelMAP_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before VelMAP is made visible.
function VelMAP_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to VelMAP (see VARARGIN)

% Choose default command line output for VelMAP
...
%     {@Reset2D,handles});
% UIWAIT makes VelMAP wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = VelMAP_OutputFcn(hObject, eventdata, handles) 
